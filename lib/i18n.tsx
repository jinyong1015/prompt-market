...
export const messages = {
  ko: {
    ...
    home: {
      ...
      allPrompts: "전체 프롬프트",
      count: "{count}개",
      empty: "등록된 프롬프트가 없습니다. Supabase SQL Editor에서 supabase/prompts.sql을 실행했는지 확인하세요.",
    },
    admin: {
      title: "프롬프트 관리",
      subtitle: "Supabase prompts 테이블을 직접 관리합니다.",
      add: "새 프롬프트",
      listTitle: "전체 {count}개",
      colId: "ID",
      colTitle: "제목",
      colPrice: "가격",
      colStatus: "상태",
      ...
      publish: "공개",
      unpublish: "비공개",
      empty: "등록된 프롬프트가 없습니다.",
      createTitle: "프롬프트 등록",
      editTitle: "프롬프트 수정",
      formDesc: "slug 형식의 ID는 URL(/prompt/[id])에 사용됩니다.",
      fieldId: "ID (slug)",
      fieldTitle: "제목",
      fieldPrice: "가격 (원)",
      fieldCategory: "카테고리",
      fieldModel: "모델",
      fieldShortDescription: "짧은 설명",
      fieldDescription: "상세 설명",
      fieldUsage: "활용법",
      fieldCaution: "주의사항",
      fieldPromptText: "프롬프트 본문",
      fieldImages: "이미지 URL (줄바꿈 또는 쉼표 구분)",
      fieldPublished: "공개 여부",
      cancel: "취소",
      save: "저장",
      create: "등록",
      created: "프롬프트를 등록했습니다.",
      updated: "프롬프트를 수정했습니다.",
      deleted: "프롬프트를 삭제했습니다.",
      published: "프롬프트를 공개했습니다.",
      unpublished: "프롬프트를 비공개로 변경했습니다.",
      deleteConfirm: "이 프롬프트를 삭제할까요?",
    },
    card: {
      purchased: "구매완료",
      details: "상세보기",
  ...
  en: {
    ...
    home: {
      ...
      count: "{count}",
      empty: "No prompts found. Run supabase/prompts.sql in the Supabase SQL Editor.",
    },
    admin: {
      title: "Manage prompts",
      subtitle: "CRUD for the Supabase prompts table.",
      add: "New prompt",
      listTitle: "{count} total",
      colId: "ID",
      colTitle: "Title",
      colPrice: "Price",
      colStatus: "Status",
      ...
      formDesc: "The slug ID is used in /prompt/[id] URLs.",
      fieldId: "ID (slug)",
      fieldTitle: "Title",
      fieldPrice: "Price (KRW)",
      ...
      fieldImages: "Image URLs (newline or comma separated)",
      ...
      unpublished: "Prompt unpublished.",
